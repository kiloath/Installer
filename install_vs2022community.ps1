function Install {
    ...
    Start-Process -FilePath "$Directory\VSlayout\vs_setup.exe" -ArgumentList "--add Microsoft.VisualStudio.Workload.NativeDesktop --includeRecommended --includeOptional --lang en-US --passive" -wait
