function latest_version {
    ...
    $DownloadUrl = "https://github.com/d2phap/ImageGlass/releases/latest"
...
function Install {
    ...
    $Shortcut = $WshShell.CreateShortcut("$KiloathDir\ImageGlass.lnk")
...
Write-Host "--- 安裝 ImageGlass ---"
Install
Write-Host "--- 完成 ImageGlass ---"
