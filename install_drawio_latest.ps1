...
function Install {
    ...
    $DownloadUrl = "https://github.com/jgraph/drawio-desktop/releases/download/v$latest_version/draw.io-$latest_version-windows-installer.exe"
    $KiloathDir = Join-Path $HOME "KiloathApp"
    $Directory = Join-Path $KiloathDir "DrawIO"
    $Target = Join-Path $Directory "draw.io-$latest_version-windows-installer.exe"
    $BinDir = "$Directory"
