function latest_version {
    ...
    $DownloadUrl = "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/latest"
...
function Install {
    ...
    $DownloadUrl = "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v$latest_version/npp.$latest_version.portable.x64.7z"
    $KiloathDir = Join-Path $HOME "KiloathApp"
    $Directory = Join-Path $KiloathDir "notepad++"
    $Target = Join-Path $Directory "npp.$latest_version.portable.x64.7z"
    $BinDir = "$Directory"
    $BinExe = "$BinDir\notepad++.exe"
    $AppName = "Notepad++"
